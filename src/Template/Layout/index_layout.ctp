	...
	<body class="page-header-fixed page-quick-sidebar-over-content page-container-bg-solid">
		...
		<div class="page-header navbar navbar-fixed-top">
			...
			<div class="page-header-inner">
				<!-- BEGIN LOGO -->
				<div class="page-logo" style="padding-left:2px;padding-right:2px;">
					<?php if(@$coreVariable['company_name']){ ?>
					<a href="javascript:" style="margin-top: 5px;font-size: 16px;font-weight: bold;color: white;text-decoration: none;line-height: 12px;">
						<span style="font-size:11px;"><?php echo $coreVariable['company_name']; ?></span><br/>
